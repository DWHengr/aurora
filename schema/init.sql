...
(
    ...
    `name`        varchar(22) NOT NULL COMMENT '指标名称',
    `type`        varchar(10) NOT NULL COMMENT '指标类型',
...
(
    `id`             varchar(40)  NOT NULL,
    `name`           varchar(22)  NOT NULL COMMENT '规则名称',
    `alert_object`   varchar(22)  NOT NULL COMMENT '告警对象,json{key:value}',
    `rules`          varchar(22)  NOT NULL COMMENT '告警规则,json{metric:metricId,operator:operator,value:value}',
